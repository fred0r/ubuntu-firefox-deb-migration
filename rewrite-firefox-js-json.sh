...
readonly SNAP_ROOT="$HOME/snap/firefox/common/.mozilla/firefox"
readonly FLATPAK_ROOT="$HOME/.var/app/org.mozilla.firefox/.mozilla/firefox"
readonly DEB_ROOT="$HOME/.mozilla/firefox"
...
Rewrites absolute snap/flatpak Firefox paths inside the .js and .json files
