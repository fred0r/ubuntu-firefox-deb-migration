...
readonly SNAP_ROOT="$HOME/snap/thunderbird/common/.thunderbird"
readonly FLATPAK_ROOT="$HOME/.var/app/org.mozilla.Thunderbird/.thunderbird"
readonly DEB_ROOT="$HOME/.thunderbird"
